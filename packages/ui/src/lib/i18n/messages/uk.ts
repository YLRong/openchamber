...
"layout.managedRuntime.title": "Керований Runtime",
"layout.managedRuntime.compactLabel": "MR",
"layout.managedRuntime.detailsTitle": "Деталі керованого Runtime",
"layout.managedRuntime.detailsAria": "Відкрити деталі керованого Runtime",
"layout.managedRuntime.sessionLabel": "Сесія",
"layout.managedRuntime.sessionPending": "Сесія очікується",
"layout.managedRuntime.workspaceLabel": "Робочий простір",
"layout.managedRuntime.workspaceDir": "Робочий простір: {path}",
"layout.managedRuntime.backToHub": "Назад до Hub",
"layout.managedRuntime.bootstrap.state.pending": "Очікується",
"layout.managedRuntime.bootstrap.state.running": "Клонується",
"layout.managedRuntime.bootstrap.state.succeeded": "Готово",
"layout.managedRuntime.bootstrap.state.skipped": "Повторно використано",
"layout.managedRuntime.bootstrap.state.failed": "Помилка",
"layout.managedRuntime.bootstrap.state.unknown": "Невідомо",
"layout.managedRuntime.bootstrap.reason.pendingDiagnostics": "Очікуємо діагностику bootstrap робочого простору.",
"layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured": "Репозиторій не налаштовано, тому робочий простір готовий як порожній.",
"layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized": "Знайдено та повторно використано наявний Git робочий простір.",
"layout.managedRuntime.bootstrap.reason.workspaceNotEmpty": "Робочий простір не порожній і не є Git репозиторієм, тому Runtime не перезаписував наявні файли.",
"layout.managedRuntime.bootstrap.reason.gitCloneFailed": "Клонування репозиторію не вдалося. Перевірте URL, облікові дані доступу й мережу, а потім повторіть із Hub.",
"layout.managedRuntime.bootstrap.reason.gitCheckoutFailed": "Репозиторій клоновано, але checkout не вдався. Перевірте branch або ref, налаштований у Hub.",
"layout.managedRuntime.bootstrap.reason.gitCloneRunning": "Runtime клонує налаштований репозиторій у робочий простір.",
"layout.managedRuntime.bootstrap.reason.gitCloneSucceeded": "Клонування репозиторію завершено, робочий простір готовий.",
"layout.managedRuntime.bootstrap.reason.statusReadFailed": "Runtime не зміг прочитати файл стану bootstrap робочого простору.",
"layout.managedRuntime.bootstrap.reason.unknown": "Стан bootstrap робочого простору ще не розпізнано. Перевірте сирі діагностичні дані або дочекайтеся оновлення.",
"layout.managedRuntime.bootstrap.rawReason": "Причина: {reason}",
"layout.managedRuntime.bootstrap.rawError": "Помилка: {error}",
  ...
  "header.actions.openSettings": "Налаштування",
  "header.actions.openSettingsAria": "Відкрити налаштування",

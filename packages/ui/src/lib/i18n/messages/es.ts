...
"layout.managedRuntime.title": "Runtime administrado",
"layout.managedRuntime.compactLabel": "MR",
"layout.managedRuntime.detailsTitle": "Detalles del runtime administrado",
"layout.managedRuntime.detailsAria": "Abrir detalles del runtime administrado",
"layout.managedRuntime.sessionLabel": "Sesión",
"layout.managedRuntime.sessionPending": "Sesión pendiente",
"layout.managedRuntime.workspaceLabel": "Espacio de trabajo",
"layout.managedRuntime.workspaceDir": "Espacio de trabajo: {path}",
"layout.managedRuntime.backToHub": "Volver al Hub",
"layout.managedRuntime.bootstrap.state.pending": "Pendiente",
"layout.managedRuntime.bootstrap.state.running": "Clonando",
"layout.managedRuntime.bootstrap.state.succeeded": "Listo",
"layout.managedRuntime.bootstrap.state.skipped": "Reutilizado",
"layout.managedRuntime.bootstrap.state.failed": "Falló",
"layout.managedRuntime.bootstrap.state.unknown": "Desconocido",
"layout.managedRuntime.bootstrap.reason.pendingDiagnostics": "Esperando diagnósticos de bootstrap del espacio de trabajo.",
"layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured": "No se configuró un repositorio, así que el espacio de trabajo está listo como espacio vacío.",
"layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized": "Se encontró y reutilizó un espacio de trabajo Git existente.",
"layout.managedRuntime.bootstrap.reason.workspaceNotEmpty": "El espacio de trabajo no está vacío y no es un repositorio Git, por lo que Runtime no sobrescribió archivos existentes.",
"layout.managedRuntime.bootstrap.reason.gitCloneFailed": "Falló la clonación del repositorio. Revisa la URL, las credenciales de acceso y la red, y reintenta desde Hub.",
"layout.managedRuntime.bootstrap.reason.gitCheckoutFailed": "El repositorio se clonó, pero falló el checkout. Revisa la rama o ref configurada en Hub.",
"layout.managedRuntime.bootstrap.reason.gitCloneRunning": "Runtime está clonando el repositorio configurado en el espacio de trabajo.",
"layout.managedRuntime.bootstrap.reason.gitCloneSucceeded": "La clonación del repositorio terminó y el espacio de trabajo está listo.",
"layout.managedRuntime.bootstrap.reason.statusReadFailed": "Runtime no pudo leer el archivo de estado de bootstrap del espacio de trabajo.",
"layout.managedRuntime.bootstrap.reason.unknown": "El estado de bootstrap del espacio de trabajo aún no se reconoce. Revisa los diagnósticos sin procesar o espera la actualización.",
"layout.managedRuntime.bootstrap.rawReason": "Motivo: {reason}",
"layout.managedRuntime.bootstrap.rawError": "Error: {error}",

...
export const dict = {
  ...
  'layout.managedRuntime.title': 'Managed Runtime',
  'layout.managedRuntime.compactLabel': 'MR',
  'layout.managedRuntime.detailsTitle': 'Managed runtime details',
  'layout.managedRuntime.detailsAria': 'Open managed runtime details',
  'layout.managedRuntime.sessionLabel': 'Session',
  'layout.managedRuntime.sessionPending': 'Session pending',
  'layout.managedRuntime.workspaceLabel': 'Workspace',
  'layout.managedRuntime.workspaceDir': 'Workspace: {path}',
  'layout.managedRuntime.backToHub': 'Back to Hub',
  'layout.managedRuntime.bootstrap.state.pending': 'Pending',
  'layout.managedRuntime.bootstrap.state.running': 'Cloning',
  'layout.managedRuntime.bootstrap.state.succeeded': 'Ready',
  'layout.managedRuntime.bootstrap.state.skipped': 'Reused',
  'layout.managedRuntime.bootstrap.state.failed': 'Failed',
  'layout.managedRuntime.bootstrap.state.unknown': 'Unknown',
  'layout.managedRuntime.bootstrap.reason.pendingDiagnostics': 'Waiting for workspace bootstrap diagnostics.',
  'layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured': 'No repository was configured, so the workspace is ready as an empty workspace.',
  'layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized': 'An existing Git workspace was found and reused.',
  'layout.managedRuntime.bootstrap.reason.workspaceNotEmpty': 'The workspace is not empty and is not a Git repository, so Runtime did not overwrite existing files.',
  'layout.managedRuntime.bootstrap.reason.gitCloneFailed': 'Repository clone failed. Check the URL, access credentials, and network, then retry from Hub.',
  'layout.managedRuntime.bootstrap.reason.gitCheckoutFailed': 'Repository clone completed, but checkout failed. Check the branch or ref configured in Hub.',
  'layout.managedRuntime.bootstrap.reason.gitCloneRunning': 'Runtime is cloning the configured repository into the workspace.',
  'layout.managedRuntime.bootstrap.reason.gitCloneSucceeded': 'Repository clone completed and the workspace is ready.',
  'layout.managedRuntime.bootstrap.reason.statusReadFailed': 'Runtime could not read the workspace bootstrap status file.',
  'layout.managedRuntime.bootstrap.reason.unknown': 'Workspace bootstrap status is not recognized yet. Check raw diagnostics or wait for refresh.',
  'layout.managedRuntime.bootstrap.rawReason': 'Reason: {reason}',

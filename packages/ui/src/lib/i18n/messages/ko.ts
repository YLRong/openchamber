...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.managedRuntime.title': '관리형 Runtime',
  'layout.managedRuntime.compactLabel': 'MR',
  'layout.managedRuntime.detailsTitle': '관리형 Runtime 세부 정보',
  'layout.managedRuntime.detailsAria': '관리형 Runtime 세부 정보 열기',
  'layout.managedRuntime.sessionLabel': '세션',
  'layout.managedRuntime.sessionPending': '세션 대기 중',
  'layout.managedRuntime.workspaceLabel': '워크스페이스',
  'layout.managedRuntime.workspaceDir': '워크스페이스: {path}',
  'layout.managedRuntime.backToHub': 'Hub로 돌아가기',
  'layout.managedRuntime.bootstrap.state.pending': '대기 중',
  'layout.managedRuntime.bootstrap.state.running': '클론 중',
  'layout.managedRuntime.bootstrap.state.succeeded': '준비됨',
  'layout.managedRuntime.bootstrap.state.skipped': '재사용됨',
  'layout.managedRuntime.bootstrap.state.failed': '실패',
  'layout.managedRuntime.bootstrap.state.unknown': '알 수 없음',
  'layout.managedRuntime.bootstrap.reason.pendingDiagnostics': '워크스페이스 bootstrap 진단을 기다리는 중입니다.',
  'layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured': '저장소가 구성되지 않아 빈 워크스페이스로 준비되었습니다.',
  'layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized': '기존 Git 워크스페이스를 찾아 재사용했습니다.',
  'layout.managedRuntime.bootstrap.reason.workspaceNotEmpty': '워크스페이스가 비어 있지 않고 Git 저장소가 아니므로 Runtime이 기존 파일을 덮어쓰지 않았습니다.',
  'layout.managedRuntime.bootstrap.reason.gitCloneFailed': '저장소 클론에 실패했습니다. URL, 접근 자격 증명, 네트워크를 확인한 뒤 Hub에서 다시 시도하세요.',
  'layout.managedRuntime.bootstrap.reason.gitCheckoutFailed': '저장소 클론은 완료됐지만 checkout에 실패했습니다. Hub에 설정된 branch 또는 ref를 확인하세요.',
  'layout.managedRuntime.bootstrap.reason.gitCloneRunning': 'Runtime이 설정된 저장소를 워크스페이스로 클론하고 있습니다.',
  'layout.managedRuntime.bootstrap.reason.gitCloneSucceeded': '저장소 클론이 완료되어 워크스페이스가 준비되었습니다.',
  'layout.managedRuntime.bootstrap.reason.statusReadFailed': 'Runtime이 워크스페이스 bootstrap 상태 파일을 읽지 못했습니다.',
  'layout.managedRuntime.bootstrap.reason.unknown': '워크스페이스 bootstrap 상태를 아직 인식하지 못했습니다. 원시 진단을 확인하거나 새로 고침을 기다리세요.',
  'layout.managedRuntime.bootstrap.rawReason': '이유: {reason}',
  'layout.managedRuntime.bootstrap.rawError': '오류: {error}',

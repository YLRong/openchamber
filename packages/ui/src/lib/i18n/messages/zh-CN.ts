...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.managedRuntime.title': '托管 Runtime',
  'layout.managedRuntime.compactLabel': 'MR',
  'layout.managedRuntime.detailsTitle': '托管 Runtime 详情',
  'layout.managedRuntime.detailsAria': '打开托管 Runtime 详情',
  'layout.managedRuntime.sessionLabel': '会话',
  'layout.managedRuntime.sessionPending': '会话待定',
  'layout.managedRuntime.workspaceLabel': '工作区',
  'layout.managedRuntime.workspaceDir': '工作区：{path}',
  'layout.managedRuntime.backToHub': '返回 Hub',
  'layout.managedRuntime.bootstrap.state.pending': '等待中',
  'layout.managedRuntime.bootstrap.state.running': '克隆中',
  'layout.managedRuntime.bootstrap.state.succeeded': '已就绪',
  'layout.managedRuntime.bootstrap.state.skipped': '已复用',
  'layout.managedRuntime.bootstrap.state.failed': '失败',
  'layout.managedRuntime.bootstrap.state.unknown': '未知',
  'layout.managedRuntime.bootstrap.reason.pendingDiagnostics': '正在等待工作区 bootstrap 诊断。',
  'layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured': '未配置仓库，因此工作区已作为空工作区就绪。',
  'layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized': '已发现并复用现有 Git 工作区。',
  'layout.managedRuntime.bootstrap.reason.workspaceNotEmpty': '工作区非空且不是 Git 仓库，Runtime 没有覆盖现有文件。',
  'layout.managedRuntime.bootstrap.reason.gitCloneFailed': '仓库克隆失败。请检查 URL、访问凭据和网络，然后从 Hub 重试。',
  'layout.managedRuntime.bootstrap.reason.gitCheckoutFailed': '仓库已克隆，但 checkout 失败。请检查 Hub 中配置的分支或 ref。',
  'layout.managedRuntime.bootstrap.reason.gitCloneRunning': 'Runtime 正在把配置的仓库克隆到工作区。',
  'layout.managedRuntime.bootstrap.reason.gitCloneSucceeded': '仓库克隆完成，工作区已就绪。',
  'layout.managedRuntime.bootstrap.reason.statusReadFailed': 'Runtime 无法读取工作区 bootstrap 状态文件。',
  'layout.managedRuntime.bootstrap.reason.unknown': '暂未识别工作区 bootstrap 状态。请查看原始诊断或等待刷新。',
  'layout.managedRuntime.bootstrap.rawReason': '原因：{reason}',
  'layout.managedRuntime.bootstrap.rawError': '错误：{error}',
  ...
  'header.actions.openSettings': '设置',
  'header.actions.openSettingsAria': '打开设置',

...
"layout.managedRuntime.title": "Runtime gerenciado",
"layout.managedRuntime.compactLabel": "MR",
"layout.managedRuntime.detailsTitle": "Detalhes do runtime gerenciado",
"layout.managedRuntime.detailsAria": "Abrir detalhes do runtime gerenciado",
"layout.managedRuntime.sessionLabel": "Sessão",
"layout.managedRuntime.sessionPending": "Sessão pendente",
"layout.managedRuntime.workspaceLabel": "Workspace",
"layout.managedRuntime.workspaceDir": "Workspace: {path}",
"layout.managedRuntime.backToHub": "Voltar ao Hub",
"layout.managedRuntime.bootstrap.state.pending": "Pendente",
"layout.managedRuntime.bootstrap.state.running": "Clonando",
"layout.managedRuntime.bootstrap.state.succeeded": "Pronto",
"layout.managedRuntime.bootstrap.state.skipped": "Reutilizado",
"layout.managedRuntime.bootstrap.state.failed": "Falhou",
"layout.managedRuntime.bootstrap.state.unknown": "Desconhecido",
"layout.managedRuntime.bootstrap.reason.pendingDiagnostics": "Aguardando diagnósticos de bootstrap do workspace.",
"layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured": "Nenhum repositório foi configurado, então o workspace está pronto como workspace vazio.",
"layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized": "Um workspace Git existente foi encontrado e reutilizado.",
"layout.managedRuntime.bootstrap.reason.workspaceNotEmpty": "O workspace não está vazio e não é um repositório Git, então o Runtime não sobrescreveu arquivos existentes.",
"layout.managedRuntime.bootstrap.reason.gitCloneFailed": "A clonagem do repositório falhou. Verifique URL, credenciais de acesso e rede, e tente novamente pelo Hub.",
"layout.managedRuntime.bootstrap.reason.gitCheckoutFailed": "O repositório foi clonado, mas o checkout falhou. Verifique o branch ou ref configurado no Hub.",
"layout.managedRuntime.bootstrap.reason.gitCloneRunning": "O Runtime está clonando o repositório configurado para o workspace.",
"layout.managedRuntime.bootstrap.reason.gitCloneSucceeded": "A clonagem do repositório terminou e o workspace está pronto.",
"layout.managedRuntime.bootstrap.reason.statusReadFailed": "O Runtime não conseguiu ler o arquivo de status de bootstrap do workspace.",
"layout.managedRuntime.bootstrap.reason.unknown": "O status de bootstrap do workspace ainda não é reconhecido. Veja os diagnósticos brutos ou aguarde a atualização.",
"layout.managedRuntime.bootstrap.rawReason": "Motivo: {reason}",
"layout.managedRuntime.bootstrap.rawError": "Erro: {error}",
  ...
  "header.actions.openSettings": "Configurações",
  "header.actions.openSettingsAria": "Abrir configurações",

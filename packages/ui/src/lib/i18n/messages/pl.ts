...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.managedRuntime.title': 'Zarządzany Runtime',
  'layout.managedRuntime.compactLabel': 'MR',
  'layout.managedRuntime.detailsTitle': 'Szczegóły zarządzanego Runtime',
  'layout.managedRuntime.detailsAria': 'Otwórz szczegóły zarządzanego Runtime',
  'layout.managedRuntime.sessionLabel': 'Sesja',
  'layout.managedRuntime.sessionPending': 'Sesja oczekuje',
  'layout.managedRuntime.workspaceLabel': 'Obszar roboczy',
  'layout.managedRuntime.workspaceDir': 'Obszar roboczy: {path}',
  'layout.managedRuntime.backToHub': 'Wróć do Hub',
  'layout.managedRuntime.bootstrap.state.pending': 'Oczekuje',
  'layout.managedRuntime.bootstrap.state.running': 'Klonowanie',
  'layout.managedRuntime.bootstrap.state.succeeded': 'Gotowe',
  'layout.managedRuntime.bootstrap.state.skipped': 'Użyto ponownie',
  'layout.managedRuntime.bootstrap.state.failed': 'Niepowodzenie',
  'layout.managedRuntime.bootstrap.state.unknown': 'Nieznane',
  'layout.managedRuntime.bootstrap.reason.pendingDiagnostics': 'Oczekiwanie na diagnostykę bootstrap obszaru roboczego.',
  'layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured': 'Nie skonfigurowano repozytorium, więc obszar roboczy jest gotowy jako pusty.',
  'layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized': 'Znaleziono i użyto ponownie istniejący obszar roboczy Git.',
  'layout.managedRuntime.bootstrap.reason.workspaceNotEmpty': 'Obszar roboczy nie jest pusty i nie jest repozytorium Git, więc Runtime nie nadpisał istniejących plików.',
  'layout.managedRuntime.bootstrap.reason.gitCloneFailed': 'Klonowanie repozytorium nie powiodło się. Sprawdź URL, dane dostępu i sieć, a potem ponów z Hub.',
  'layout.managedRuntime.bootstrap.reason.gitCheckoutFailed': 'Repozytorium zostało sklonowane, ale checkout nie powiódł się. Sprawdź branch lub ref skonfigurowany w Hub.',
  'layout.managedRuntime.bootstrap.reason.gitCloneRunning': 'Runtime klonuje skonfigurowane repozytorium do obszaru roboczego.',
  'layout.managedRuntime.bootstrap.reason.gitCloneSucceeded': 'Klonowanie repozytorium zakończone, obszar roboczy jest gotowy.',
  'layout.managedRuntime.bootstrap.reason.statusReadFailed': 'Runtime nie mógł odczytać pliku statusu bootstrap obszaru roboczego.',
  'layout.managedRuntime.bootstrap.reason.unknown': 'Status bootstrap obszaru roboczego nie jest jeszcze rozpoznany. Sprawdź surową diagnostykę albo poczekaj na odświeżenie.',
  'layout.managedRuntime.bootstrap.rawReason': 'Powód: {reason}',
  'layout.managedRuntime.bootstrap.rawError': 'Błąd: {error}',

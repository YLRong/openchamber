...
export const dict: Record<I18nKey, string> = {
  ...
  'layout.managedRuntime.title': '託管 Runtime',
  'layout.managedRuntime.compactLabel': 'MR',
  'layout.managedRuntime.detailsTitle': '託管 Runtime 詳情',
  'layout.managedRuntime.detailsAria': '開啟託管 Runtime 詳情',
  'layout.managedRuntime.sessionLabel': '會話',
  'layout.managedRuntime.sessionPending': '會話待定',
  'layout.managedRuntime.workspaceLabel': '工作區',
  'layout.managedRuntime.workspaceDir': '工作區：{path}',
  'layout.managedRuntime.backToHub': '返回 Hub',
  'layout.managedRuntime.bootstrap.state.pending': '等待中',
  'layout.managedRuntime.bootstrap.state.running': '複製中',
  'layout.managedRuntime.bootstrap.state.succeeded': '已就緒',
  'layout.managedRuntime.bootstrap.state.skipped': '已重用',
  'layout.managedRuntime.bootstrap.state.failed': '失敗',
  'layout.managedRuntime.bootstrap.state.unknown': '未知',
  'layout.managedRuntime.bootstrap.reason.pendingDiagnostics': '正在等待工作區 bootstrap 診斷。',
  'layout.managedRuntime.bootstrap.reason.repoUrlNotConfigured': '未設定倉庫，因此工作區已作為空工作區就緒。',
  'layout.managedRuntime.bootstrap.reason.workspaceAlreadyInitialized': '已找到並重用現有 Git 工作區。',
  'layout.managedRuntime.bootstrap.reason.workspaceNotEmpty': '工作區非空且不是 Git 倉庫，Runtime 沒有覆蓋現有檔案。',
  'layout.managedRuntime.bootstrap.reason.gitCloneFailed': '倉庫複製失敗。請檢查 URL、存取憑證和網路，然後從 Hub 重試。',
  'layout.managedRuntime.bootstrap.reason.gitCheckoutFailed': '倉庫已複製，但 checkout 失敗。請檢查 Hub 中設定的分支或 ref。',
  'layout.managedRuntime.bootstrap.reason.gitCloneRunning': 'Runtime 正在把設定的倉庫複製到工作區。',
  'layout.managedRuntime.bootstrap.reason.gitCloneSucceeded': '倉庫複製完成，工作區已就緒。',
  'layout.managedRuntime.bootstrap.reason.statusReadFailed': 'Runtime 無法讀取工作區 bootstrap 狀態檔。',
  'layout.managedRuntime.bootstrap.reason.unknown': '暫未識別工作區 bootstrap 狀態。請查看原始診斷或等待重新整理。',
  'layout.managedRuntime.bootstrap.rawReason': '原因：{reason}',
  'layout.managedRuntime.bootstrap.rawError': '錯誤：{error}',
